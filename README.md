...
For the public contact/quote forms, add:

```
VITE_FORM_WORKER_URL=https://<your-cloudflare-worker-url>
```

Sensitive keys for the worker should be configured via Wrangler secrets (do **not** commit these):

```
RESEND_API_KEY=...
CONTACT_EMAIL=you@example.com
# Optionally restrict CORS with a comma-separated list
ALLOWED_ORIGIN=https://desertsportsmed.com
```
