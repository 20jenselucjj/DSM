...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Content
    ...
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-none bg-background p-1 text-popover-foreground shadow-none opacity-0 data-[state=open]:opacity-100 transition-opacity duration-75",
      className,
    )}
    {...props}
  />
